...
(function () {
    ...
    Markdown.Converter = function () {
        ...
        function q(X) {
            var W = "p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math|ins|del";
            var V = "p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math";
        ...
        var z = "[-A-Z0-9+&@#/%?=~_|[\\]()!:,.;]", U = "[-A-Z0-9+&@#/%=~_|[\\])]",
            L = new RegExp('(="|<)?\\b(https?|ftp)(://' + z + "*" + U + ")(?=$|\\W)", "gi"), R = new RegExp(U, "i");
...
(function () {
    ...
    a.getSanitizingConverter = function () {
        var i = new d();
...
(function () {
    ...
    function k(x) {
        this.buttonBar = w.getElementById("md-button-bar" + x);
    ...
    function t(K, E, M, A, J, I, D, y) {
        ...
        if (v.isIE) {
            a.addEvent(C, "keydown", function (N) {
                var O = N.keyCode;
                if (O === 27) {
                    return false
                }
        ...
        function x(N, P) {
            ...
            if (P) {
                R.style.backgroundPosition = N.XShift + " " + Q;
                N.onmouseover = function () {
                    R.style.backgroundPosition = this.XShift + " " + O
                };
                N.onmouseout = function () {
                    R.style.backgroundPosition = this.XShift + " " + Q
                };
                if (v.isIE) {
                ...
                R.style.backgroundPosition = N.XShift + " " + S;
        ...
        function B() {
            ...
            P(1);
            G.link = W("md-link-button", y("link"), "-40px", z(function (Y, Z) {
                return this.doLinkOrImage(Y, Z, false)
            }));
            G.quote = W("md-quote-button", y("quote"), "-60px", z("doBlockquote"));
            G.code = W("md-code-button", y("code"), "-80px", z("doCode"));
            G.image = W("md-image-button", y("image"), "-100px", z(function (Y, Z) {
                return this.doLinkOrImage(Y, Z, true)
            }));
            P(2);
            G.olist = W("md-olist-button", y("olist"), "-120px", z(function (Y, Z) {
                this.doList(Y, Z, true)
            }));
            G.ulist = W("md-ulist-button", y("ulist"), "-140px", z(function (Y, Z) {
                this.doList(Y, Z, false)
            }));
            ...
            G.undo.execute = function (Y) {
                if (Y) {
                    Y.undo()
                }
            };
            var X = /win/.test(g.platform.toLowerCase()) ? y("redo") : y("redomac");
            G.redo = W("md-redo-button", X, "-220px", null);
            G.redo.execute = function (Y) {
                if (Y) {
                    Y.redo()
                }
            };
    ...
    function p(x) {
        return x.replace(/^\s*(.*?)(?:\s+"(.+)")?\s*$/, function (z, y, A) {
            y = y.replace(/\?.*$/, function (B) {
                return B.replace(/\+/g, " ")
            });
            ...
            if (A) {
                A = A.trim ? A.trim() : A.replace(/^\s*/, "").replace(/\s*$/, "");
                A = A.replace(/"/g, "quot;").replace(/\(/g, "&#40;").replace(/\)/g, "&#41;").replace(/</g, "&lt;").replace(/>/g, "&gt;")
            }
            return A ? y + ' "' + A + '"' : y
        })
    }
